...
import Level1ClearCheck from '../../assets/level1ClearCheck.mp4'
...
const Levels = (): ReactElement => {
    ...
    const levels = [
        {levelImg: Level1, levelCode: '9XR-RRG-CBG', clearCheckVid: Level1ClearCheck, clearRate: '0.24%', clearTime: '1HRS 47MIN', finished: true},
        {levelImg: Level2, levelCode: 'QBH-MNS-1SF', clearCheckVid: Level1ClearCheck, clearRate: '0.22%', clearTime: '0HRS 30MIN', finished: true},
        {levelImg: Level3, levelCode: 'WML-PWV-SMG', clearCheckVid: Level1ClearCheck, clearRate: '0.47%', clearTime: '0HRS 46MIN', finished: true},
        {levelImg: Level4, levelCode: '415-D31-40H', clearCheckVid: Level1ClearCheck, clearRate: '0.33%', clearTime: '4HRS 21MIN', finished: true},
        {levelImg: Level5, levelCode: 'H77-Y7M-RWF', clearCheckVid: Level1ClearCheck, clearRate: '0.12%', clearTime: '11HRS 34MIN', finished: true},
    ...
    return (
        <div className='levels'>
            ...
            <div>
                ...
                <video className='levelVideo' width={isMobile ? "360" : "1120"} height={isMobile ? "200" : "630"} controls>
                    <source src={currentLevel.clearCheckVid} type="video/mp4"/>
                </video>
